...
if __name__ == "__main__":
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        try:
            ...
            max_angle_x = 0.01 # max lean angle for xz plane
            max_angle_y = 0.01 # max lean angle for yz plane
            max_angle = 0.1
            desired_angle_roll = 0 #left_x * max_angle_x 
            # YZ-plane steering controller
            desired_angle_pitch = left_x * max_angle_y #left_y * max_angle_y
            # Rotation controller
            Tz = right_x * max_angle


            resting_angle = 0.0
            #desired_angle_x = desired_angle_roll # + resting_angle
            #desired_angle_y = desired_angle_pitch # + resting_angle
            # resting_angle = 0.0
            ...
            if(t_now > 15.00):
                errorx = desired_angle_roll - roll
                errory = desired_angle_pitch - pitch
                errorz = resting_angle - yaw
