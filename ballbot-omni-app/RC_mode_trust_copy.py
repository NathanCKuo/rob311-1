...
if __name__ == "__main__":
    ...
    data_name = ['i', 't_now', 'roll', 'pitch', 'yaw', 'Tx', 'Ty', 'Tz', 'T1', 'T2', 'T3', 'psi_1', 'psi_2','psi_3', 'Tpx', 'Tpy', 'Tix', 'Tiy', 'Tdx', 'Tdy', 'error_x', 'error_y', 'PID_x', Kp_x, Ki_x, Kd_x, 'PID_y', Kp_y, Ki_y, Kd_y]
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        try:
            ...
            if(t_now > 15.00):
                ...
                errorx = desired_angle_x - roll #- 0.005
                #de.append(desired_angle - roll)
                #if(len(de) > 10):
                #    sumx = de.popleft()
                #    for x in de:
                #        sumx += x
