...
Edit data: 03/26/2025
Edited to implement balance and steering controllers for ballbot
"""
...
if __name__ == "__main__":
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        try:
            ...
            # Controller for balance and steering:
            ...
            T1, T2, T3 = compute_motor_torques(Tx, Ty, Tz) # for floor test
